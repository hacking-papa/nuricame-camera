...
class ST7789(object):
    ...
    def SetWindows(self, start_x, start_y, end_x, end_y):
        # set the X coordinates
        self.command(0x2A)
        self.data(0x00)  # Set the horizontal starting point to the high octet
        self.data(start_x & 0xFF)  # Set the horizontal starting point to the low octet
        self.data(0x00)  # Set the horizontal end to the high octet
        self.data((end_x - 1) & 0xFF)  # Set the horizontal end to the low octet

        # set the Y coordinates
        self.command(0x2B)
        self.data(0x00)
        self.data((start_y & 0xFF))
        self.data(0x00)
        self.data((end_y - 1) & 0xFF)

        self.command(0x2C)

    def ShowImage(self, Image, start_x, start_y):
